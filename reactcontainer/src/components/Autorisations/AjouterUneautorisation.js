...
const[alertheures,setAlertHeures]=useState(false)
  ...
  const handlesubmit = (e) => {
    ...
    if (minutes <= 120 || minutes > 0) {
      ...
      const conge = { employes, validation, date_autorisation, heure_debut, heure_fin, personneinterimaire, datetimereprise, commentaire,validationrh,validationrh2 , motif_abs }
      setDisable(true)
      fetch(url+"demendeconges/" + iduserinfo + "/" + "autorisation/" + date_autorisation + "/" + date_autorisation+"/0"+"/0",
        {
          method: "POST",
          headers: {
              ...
              <div className="row">
                         ...
                         <div className='col-md-12'>
                             <TextField
                               ...
                               fullWidth
                             >
                               {motifs.filter(x=> x.motifautorisation == true).map((option) => (
                  ...
                  <div className='row'>
                    ...
                    <div className='col-md-6'>
                      <div className="form-group">
                        ...
                        <input className="form-control" placeholder="heure_debut" value={heure_fin} name="heure_fin" onChange={(e) => setHeurefin(e.target.value)} type="time" />
                  ...
                  {alerterror &&
                                ...
                                Erreur!
                                    ...
                                    {alertheures &&
                                      <Alert variant="filled" severity="error">
                               Les heures d'autorisations sont invalides ou supérieures à 2 heures ! SVP passez un congé
                                    </Alert> }
