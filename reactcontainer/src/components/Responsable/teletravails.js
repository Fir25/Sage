  ...
  const ValiderConge =async (id,iduser,datedebut,datefin,validation,validationrh,validationrh2) => {
      ...
      if(DRH==true ||   role=="admin"){
       ...
       //  sendMail(emaildrh,"IPS Time:  Avis Favorable pour la demande de téletravail "+user_name + "   " + last_name ,"Bonjour, La demande de téletravail du collaborateur "+user_name + "   " + last_name+"  du "+datedebut+" au "+datefin+"  est validé avec un avis favorable  !")
        ...
        if (  validationrhh == 0 || validationrhh == "" ||  validationrhh == null  ||  validationrhh == undefined){
         ...
         // sendMail(emailchef,"IPS Time:  Avis Favorable par manager 1 pour la demande  de téletravail  "+user_name + "   " + last_name ," Bonjour, La demande  de téletravail du collaborateur "+user_name + "   " + last_name+"  du "+datedebut+" au "+datefin+"  est validé avec un avis favorable par manager 1  !")  
        ...
        alert('vous êtes pas autorisé pour valider ce téletravail ! ')
      }
    ...
    const onClickRefuser = (id,iduserr,datedebut,datefin,validationn,validationrhh,idchef,idrh,emailemploye,emailchef,user_name,last_name,emailrhf,idrh2f,emailrh2f,validationrh2f) => {
      ...
      if(DRH==true ||   role=="admin"){
        ...
        //  sendMail(emailchef,"IPS Time:  Avis défavorable par  rh pour la demande de téletravail "+user_name + "   " + last_name ,"Bonjour, La demande de téletravail du collaborateur "+user_name + "   " + last_name+"  du "+datedebut+" au "+datefin+"  est refusé avec un avis défavorable par   rh!")
      ...
      if ( validationrhh == 0 || validationrhh == "" ||  validationrhh == null  ||  validationrhh == undefined){
      sendMail(emailemploye,"IPS Time:  Avis défavorable pour la demande de téletravail","Bonjour , Votre demande de téletravail du "+datedebut+" au "+datefin+" a été refusé par un avis défavorable!")
        //sendMail(emailchef,"IPS Time:   Avis défavorable par manager pour la demande du téletravail  "+user_name + "   " + last_name ," Bonjour, La demande de congé du collaborateur "+user_name + "   " + last_name+"  du "+datedebut+" au "+datefin+"  est refusé avec un avis défavorable par manager  !")  
    ...
    alert('vous êtes pas autorisé pour refuser ce téletravail ! ')
  }
  {/**
...
if (validationrhh==''){
  ...
  alert('le télétravail est déja validé')
    ...
    if ( validationrh2f == 0 || validationrh2f == "" ||  validationrh2f == null  ||  validationrh2f == undefined){
      ...
      const validationrh2ff="refusé  par manager"
...
<tbody>
{
  role=="admin" || DRH==true?Conges.map(c =>
