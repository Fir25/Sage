  ...
  // sendMail(emailchef,"IPS Time:  Avis Favorable  par rh pour la demande du mission "+user_name + "   " + last_name ,"Bonjour, La demande de mission du collaborateur "+user_name + "   " + last_name+"  du "+datedebut+" au "+datefin+"  est validé avec un avis favorable par rh!")
    ...
    const validationrh222=2
      if (validationn==''){
       ...
       // sendMail(emailemploye,"IPS Time: avis favorable pour la demande du mission","Bonjour "+user_name+" "+last_name+",  Votre manager 1 a validé le mission de votre demande du " + datedebut + " au " + datefin + " L'avis de chef est importante pour la confirmation définitive!")
       // sendMail(emailchef,"IPS Time:  Avis Favorable par manager 1 pour la demande du mission  "+user_name + "   " + last_name ," Bonjour, La demande de mission du collaborateur "+user_name + "   " + last_name+"  du "+datedebut+" au "+datefin+"  est validé avec un avis favorable par manager 1  !")  
       // sendMail(emailrh,"IPS Time:  Avis Favorable pour la demande du mission "+user_name + "   " + last_name ," Bonjour, La demande de mission du collaborateur "+user_name + "   " + last_name+"  du "+datedebut+" au "+datefin+"  est validé avec un avis favorable !")
        ...
        alert('vous êtes pas autorisé pour valider cette mission ! ')
      }
    ...
    const onClickRefuser = (id,iduserr,datedebut,datefin,validationn,validationrhh,idchef,idrh,emailemploye,emailchef,user_name,last_name,idrh2f,emailrh2f,nomrh2f,emailrhf,validationrh2f) => {
      ...
      if (  validationrhh == 0 || validationrhh == "" ||  validationrhh == null  ||  validationrhh == undefined){
    sendMail(emailemploye,"IPS Time: Avis défavorable pour la demande de mission","Bonjour  "+user_name+"  "+last_name+",  Votre demande de mission  de " + datedebut + " au " + datefin+" a été refusé avec avis défavorable" )
    //sendMail(emailchef,"IPS Time:   Avis défavorable par manager pour la demande du mission  "+user_name + "   " + last_name ," Bonjour, La demande de mission du collaborateur "+user_name + "   " + last_name+"  du "+datedebut+" au "+datefin+"  est refusé avec un avis défavorable par manager  !")  
   // sendMail(emailrhf,"IPS Time:   Avis défavorable pour la demande du mission"+user_name + "   " + last_name ," Bonjour, La demande de mission du collaborateur "+user_name + "   " + last_name+"  du "+datedebut+" au "+datefin+"  est refusé avec un avis défavorable!")
    ...
    alert('vous êtes pas autorisé pour refuser cette mission ! ')
  }
